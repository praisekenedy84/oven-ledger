...
const STATUS_COLORS = {
    ...
    rent: { bg: `${colors.ink}14`, color: colors.ink },
    utilities: { bg: `${colors.butter}24`, color: '#8A6410' },
    salaries: { bg: `${colors.sage}1f`, color: colors.sage },
    transport: { bg: colors.wheatLight, color: colors.ink },
    fees: { bg: `${colors.jam}1a`, color: colors.jam },
    packaging: { bg: `${colors.butter}24`, color: '#8A6410' },
    marketing: { bg: `${colors.sage}1f`, color: colors.sage },
    maintenance: { bg: `${colors.ink}14`, color: colors.ink },
