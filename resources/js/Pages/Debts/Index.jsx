...
export default function Index({ liabilities, ownerTransactions, branches, filters, totals }) {
    ...
    return (
        <TenantLayout title="Debts">
            ...
            <PageHeader
                title="Debts"
                description="What the bakery owes, plus owner capital in and drawings out."
            />
            ...
            >
                {[
                    { label: 'Open payables', value: totals.payables_open },
            ...
            <Stack direction="row" spacing={1} useFlexGap flexWrap="wrap" alignItems="center" sx={{ mb: 3 }}>
                {[
                    ...
                    <Button
                        ...
                        sx={{
                            borderRadius: 999,
                            borderColor: tab === item.key ? colors.wheat : colors.border,
                            bgcolor: tab === item.key ? colors.wheatLight : 'transparent',
                            color: tab === item.key ? colors.cocoa : colors.muted,
                            fontWeight: 600,
                        }}
                    >
                        {item.label}
            ...
            {tab === 'payables' ? (
                ...
                <>
                    <Paper
                        ...
                        onSubmit={(e) => {
                            e.preventDefault();
                            ownerForm.post(route('tenant.owner-transactions.store'), {
                    ...
                    >
                        ...
                        <Box>
                            ...
                            <TextInput
                                ...
                                onChange={(e) =>
                                    ownerForm.setData('transacted_at', e.target.value)
                                }
                            />
                        </Box>
                        <Box sx={{ display: 'flex', alignItems: 'flex-end' }}>
